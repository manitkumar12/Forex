...
public class Beginner_forex_video_five_question extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next = (CardView) findViewById(R.id.beginner_five_card);
        next1 = (TextView) findViewById(R.id.beginner_five_text);

        next1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Beginner_forex_video_five_question.this,Beginner_forex_video_six_question.class);
                startActivity(i);
            }
        });
